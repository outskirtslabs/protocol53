...
Until the first release, use Git coordinates and select the API and provider modules with `:deps/root`:

[source,clojure]
----
{:deps {com.outskirtslabs/protocol53
        {:git/url "https://github.com/outskirtslabs/protocol53.git"
         :git/sha "fb1a85b9d1a88de39709574df6198d2bd93ebda3"
         :deps/root "api"}
...
Provider modules are also available under `providers/desec` and
`providers/porkbun` with the coordinates
`com.outskirtslabs/protocol53-desec` and
`com.outskirtslabs/protocol53-porkbun`.
...
* https://github.com/outskirtslabs/protocol53/tree/main/providers/cloudflare[Cloudflare]
* https://github.com/outskirtslabs/protocol53/tree/main/providers/desec[deSEC]
* https://github.com/outskirtslabs/protocol53/tree/main/providers/porkbun[Porkbun]
